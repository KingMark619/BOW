function n(t, r, o, e) {
    ...
    if (d.isArray(r)) d.each(r, function(r, u) {
        o || b.test(t) ? e(t, u) : n(t + "[" + ("object" === (void 0 === u ? "undefined" : i(u)) ? r : "") + "]", u, o, e);
    }); else if (o || "object" !== d.type(r)) e(t, r); else for (u in r) n(t + "[" + u + "]", r[u], o, e);
}
...
var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(n) {
...
}, i = "function" == typeof Symbol && "symbol" == e(Symbol.iterator) ? function(n) {
...
}, u = {}, f = [], c = f.push, l = f.indexOf, a = u.toString, y = u.hasOwnProperty, s = "1.10.2".trim, p = /%20/g, b = /\[\]$/, d = {
    ...
    type: function(n) {
        return null == n ? String(n) : "object" === (void 0 === n ? "undefined" : i(n)) || "function" == typeof n ? u[a.call(n)] || "object" : void 0 === n ? "undefined" : i(n);
    },
    isPlainObject: function(n) {
        var t;
        if (!n || "object" !== d.type(n) || n.nodeType || d.isWindow(n)) return !1;
        try {
            if (n.constructor && !y.call(n, "constructor") && !y.call(n.constructor.prototype, "isPrototypeOf")) return !1;
        } catch (n) {
            return !1;
        }
        if (d.support.ownLast) for (t in n) return y.call(n, t);
        for (t in n) ;
        return void 0 === t || y.call(n, t);
    },
    ...
    makeArray: function(n, r) {
        var o = r || [];
        return null != n && (t(Object(n)) ? d.merge(o, "string" == typeof n ? [ n ] : n) : c.call(o, n)), 
        o;
    },
    inArray: function(n, t, r) {
        var o;
        if (t) {
            if (l) return l.call(t, n, r);
...
d.extend = function() {
    var n, t, r, o, e, u, f = arguments[0] || {}, c = 1, l = arguments.length, a = !1;
    for ("boolean" == typeof f && (a = f, f = arguments[1] || {}, c = 2), "object" === (void 0 === f ? "undefined" : i(f)) || d.isFunction(f) || (f = {}), 
    l === c && (f = this, --c); c < l; c++) if (null != (n = arguments[c])) for (t in n) r = f[t], 
    f !== (o = n[t]) && (a && o && (d.isPlainObject(o) || (e = d.isArray(o))) ? (e ? (e = !1, 
