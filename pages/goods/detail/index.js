...
Page((a = {
    ...
    e.setData({
      ...
      if (e.setData({
        ...
        l.wxParse("wxParseData_buycontent", "html", t.goods.buycontent, e, "0"), e.setData({
          ...
          title: t.goods.title || "details of goods"
      ...
      if (t.goods.ispresell > 0) {
        ...
        e.setData({
          ...
          preselltimeend: t.goods.preselltimeend || t.goods.preselltimeend.getMonth() + " month" + t.goods.preselltimeend || t.goods.preselltimeend.getDate() + "sun " + t.goods.preselltimeend || t.goods.preselltimeend.getHours() + ":" + t.goods.preselltimeend || t.goods.preselltimeend.getMinutes() + ":" + t.goods.preselltimeend || t.goods.preselltimeend.getSeconds(),
          presellsendstatrttime: t.goods.presellsendstatrttime || t.goods.presellsendstatrttime.getMonth() + " month" + t.goods.presellsendstatrttime || t.goods.presellsendstatrttime.getDate() + "sun"
        });
      }
  ...
  countDown: function (t, e, a) {
    ...
    if (this.setData({
      ...
      var l = "";
      t > o ? l = "The distance limit purchase begins" : t <= o && e > o ? l = "End of time limit distance purchase" : (l = "The activity is over. Come earlier next time~",
        this.setData({
          istime: 0
        })), this.setData({
          istimeTitle: l
  ...
  couponrecived: function (t) {
    ...
    i.post("goods.pay_coupon", {
      ...
      console.log(t), 0 == t.error ? (a.setData({
        showcoupon: !1,
        active: ""
      }), s.toast(a, "already received")) : s.toast(a, t.message);
    });
  },
  ...
  select: function () {
    ...
    t.data.diyform;
    u > 0 && 0 == e ? s.toast(t, "Please select the specification") : this.setData({
      active: "",
      slider: "out",
      isSelected: !0,
      tempname: ""
  ...
  onLoad: function (t) {
    ...
    i.get("black", {}, function (t) {
      t.isblack && wx.showModal({
        title: "cannot access",
        content: "You are in the blacklist of the mall, have no right to access!",
        success: function (t) {
  ...
  show_cycelbuydate: function () {
    var t = this, e = g.getCurrentDayString(this, t.data.showDate), a = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    t.setData({
      currentObj: e,
      currentDate: e.getFullYear() + "year" + (e.getMonth() + 1) + "month" + e.getDate() + "day " + a[e.getDay()],
