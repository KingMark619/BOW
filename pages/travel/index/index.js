...
Page({
  ...
  onShareAppMessage: function () {
    const image = 'https://mmbiz.qpic.cn/mmbiz_jpg/AxDUaj0Q50A2siaHib1wFtlwYJ479sd59TVVqZXJqbuyanUPSYTVIaJW7gUIQ1ibKHE64xVfbDQkfHmPtDNW3CQvg/640?wx_fmt=jpeg&wxfrom=5&wx_lazy=1&wx_co=1'
    return {
      title: 'China Students Travel',
      imageUrl: image
    };
  },
  onLoad: function (e) {
    ...
    wx.request({
      url: 'https://bestofwuhan.cn/wp-json/listing/travels/',
      data: '',
      header: {},
      method: 'GET',
      dataType: 'json',
  ...
  search() {
    wx.navigateTo({
      url: `/pages/merchant/search/search?type=travel`,
    })
  },
  ...
  getList: function () {
    ...
    // e.get("goods/get_list", t.data.params, function (e) {
    //   console.log(e.list);
    //   console.log(e)
    //   var a = {
    //     loading: !1,
  ...
  bindFilterSubmit: function () {
    ...
    // a.isEmptyObject(e) && (t = this.data.defaults), t.cate = 2, this.setData({
    //   page: 1,
    //   params: t,
    //   isFilterShow: !1,
    //   filterBtns: e,
